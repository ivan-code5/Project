...
13. Создан макет.
14. Создана структура веб-сайта в Visual Studio Code.
15. Сохранены изображения в папке images.
16. Сохранены шрифты в папке fonts.
17. Свёрстаны страницы сайта.
18. Добавлена анимация на 'hover' и 'active'.
19. Добавлена адаптивность на разные экраны (без media).
