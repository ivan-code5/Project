...
document.getElementById("calculate").addEventListener("click", function () {
    ...
    const vars = [var1, var2, var3, var4, var5, var6, var7, var8];
    let vars_res = [];
    ...
    function getResult() {
        if (var1 > 0 && var2 > 0 && var3 > 0 && var4 > 0 && var5 > 0 && var6 > 0 && var7 > 0 && var8 > 0 ) {
            let product1 = var1 * var2 * var3 * var4 * var5 * var6 * var7 * var8 * var10;
            let product2 = var1 * var2 * var3 * var4 * var5 * var6 * var7 * var8 * var11;
            let product3 = var1 * var2 * var3 * var4 * var5 * var6 * var7 * var8 * var12;
            ...
            output.innerHTML = "азот:" + " " + product1 + " " + "кг/" + "га" + ";" + " " + " " + " " + "калий:" + " " + product2 + " " + "кг/" + "га" + ";" + " " + " " + " " + "фосфор:" + " " + product3 + " " + "кг/" + "га" + ";" + " " + " " + " " + " " + "азот:" + " " + product4 + " " + "кг/га" + ";" + " " + " " + "калий:" + " " + product5 + " " + "кг/га" + ";" + " " + " " + " " + "фосфор:" + " " + product6 + " " + "кг/га" + ".";
        }
        else {
