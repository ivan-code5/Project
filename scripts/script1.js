...
function getResult() {
    if (var1 > 0 && var2 > 0 && var3 > 0 && var4 > 0 && var5 > 0 && var6 > 0 && var7 > 0 && var8 > 0) {
        ...
        let product4 = var1 * var2 * var3 * var4 * var5 * var6 * var7 * var8 * var12;
        let product5 = var1 * var2 * var3 * var4 * var5 * var6 * var7 * var8 * var12;
        let product6 = var1 * var2 * var3 * var4 * var5 * var6 * var7 * var8 * var12;
        let output = document.getElementById("result");
        output.innerHTML = "азот" + " " + product1 + " " + "кг/" + var9 + "га" + ";" + " " + "калий" + " " + product2 + " " + "кг/" + var9 + "га" + ";" + " " + "фосфор" + " " + product3 + " " + "кг/" + var9 + "га" + ";" + " " + product4 + " " + "кг/га" + ";" + " " + product5 + " " + "кг/га" + ";" + " " + product6 + " " + "кг/га" + ".";
